...
<div class="dtree">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/css/dtree.js"></script>
	<script type="text/javascript">
	  <!--   
		...
		d.add('010201','0102','分类管理','${pageContext.request.contextPath}/admin/category.do','','mainFrame');
	...
	//	d.add('010401','0104','商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProductsWithPage&num=1','提示信息','mainFrame');
		d.add('010401','0104','电影管理','${pageContext.request.contextPath}/admin/findAllProduct.do?num=1','提示信息','mainFrame');
		//d.add('010402','0104','已下架商品管理','${pageContext.request.contextPath}/admin/product/pushDown_list.jsp','','mainFrame');
		d.add('010402','0104','已下架电影管理','${pageContext.request.contextPath}/admin/product/pushDown_list.jsp','','mainFrame');
