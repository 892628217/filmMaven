            ...
            <dl class="content">
                ...
                <dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button onclick="setorder()" class="new-btn-login" type="submit" style="text-align: center;">付 款</button>
...
<script language="javascript">
    ...
    function setorder() {
     ...
     var setseat=   document.getElementById("WIDbody").value;
     var oid=   document.getElementById("WIDout_trade_no").value;


        var vNow = new Date();
        var sNow = "";
        sNow += String(vNow.getFullYear())+"年";
        sNow += String(vNow.getMonth() + 1)+"月";
        sNow += String(vNow.getDate())+"日";
        ...
        $.post("/pay/setorder.do" , {setseat:setseat,oid:oid,fid:"${id}",price:"${price}",times:sNow} , function(data , status){
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDsubject").value = "${name}";
        document.getElementById("WIDtotal_amount").value = "${price}";
        document.getElementById("WIDbody").value = "${seats}";
